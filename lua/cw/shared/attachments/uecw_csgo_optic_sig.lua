...
if CLIENT then
	att.displayIcon = surface.GetTextureID("gmod4phun/uecw/icons/upgr_csgo_556scope")
	...
	local old, x, y, ang
	local reticle = surface.GetTextureID("gmod4phun/uecw/reticles/sg556_scope_reticle")

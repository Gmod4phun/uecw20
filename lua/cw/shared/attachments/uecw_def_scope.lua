local att = {}
att.name = "uecw_def_scope"
att.displayName = "High Powered Tactical 10x Scope"
att.displayNameShort = "Hi-Power"
att.aimPos = {"DefScopePos", "DefScopeAng"}
att.FOVModifier = 15
att.isSight = true
att.isBG = true
...
if CLIENT then
	att.displayIcon = surface.GetTextureID("gmod4phun/uecw/icons/upgr_def_scope")
	att.description = {[1] = {t = "Provides 10x magnification.", c = CustomizableWeaponry.textColors.POSITIVE},
	...
	function att:drawRenderTarget()
		...
		if self:canSeeThroughTelescopics(att.aimPos[1]) then
			...
			alpha = math.Approach(alpha, 0.9, FrameTime() * 5)
		end
...
function att:attachFunc()
	...
	self:setBodygroup(self.SightBGs.main, self.SightBGs.def_scope)
end

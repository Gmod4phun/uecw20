local att = {}
att.name = "uecw_g36k_scope"
att.displayName = "G36K Scope"
att.displayNameShort = "G36K"
att.isBG = true
att.isSight = true
att.aimPos = {"G36KPos", "G36KAng"}
att.withoutRail = true

att.statModifiers = {OverallMouseSensMult = -0.2}

if CLIENT then
	att.displayIcon = surface.GetTextureID("gmod4phun/uecw/icons/upgr_g36k_scope")
	...
	local old, x, y, ang
	local reticle = surface.GetTextureID("gmod4phun/uecw/reticles/g36k_reticle")
...
function att:attachFunc()
	...
	self:setBodygroup(self.SightBGs.main, self.SightBGs.G36K)
end
